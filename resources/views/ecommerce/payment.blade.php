                                    ...
                                    <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="transfer_to" class="form-control" required>
                                                ...
                                                <option value="BCA - 1234567">BCA: 1234567 a.n xenryu</option>
                                                <option value="Mandiri - 2345678">Mandiri: 2345678 a.n xenryu</option>
                                                <option value="BRI - 9876543">BCA: 9876543 a.n xenryu</option>
                                                <option value="BNI - 6789456">BCA: 6789456 a.n xenryu</option>
                                            </select>
